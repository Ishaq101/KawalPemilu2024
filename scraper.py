...
####>>>>>>>         SCRAPER         <<<<<<<<##
def main(vote_data=[],last_prov_id=1,last_kab_id=1,last_kec_id=1,last_kel_id=1,scroll_down_constant=2):
    try:
...
if __name__ == "__main__":
    ...
    dataframe = main(vote_data=vote_data,last_prov_id=last_prov_id,last_kab_id=last_kab_id,last_kec_id=last_kec_id,last_kel_id=last_kel_id,scroll_down_constant=scroll_down_constant)